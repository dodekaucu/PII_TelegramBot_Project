...
namespace ProgramTests
{
    ...
    public class TestBusquedaClasific
    {
        ...
        public void Setup()
        {
            ...
            Empresa barracaFernandez = new Empresa("Madera SRL", rubroMadera, "San Bautista", "Ruta 6","66444");
            Empresa carpinteriaRodriguez = new Empresa("Madera SRL", rubroMadera, "San Bautista", "Ruta 6","6664333");
