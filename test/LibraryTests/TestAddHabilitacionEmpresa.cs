//--------------------------------------------------------------------------------
// <copyright file="TestAddHabilitacionEmpresa.cs" company="Universidad Católica del Uruguay">
...
namespace ProgramTests
{
    ...
    public class TestAddHabilitacionEmpresa
    {
        ...
        public void Setup()
        {
            ...
            db.AddEmpresa("Barraca Fernandez", rubroMadera, "San Bautista", "Ruta 6","2555","099222333");
